...
def findMethod(clone):    
    ...
    #images = [gray, blurred, thresh, img, grey, adthresh, bilateral_filtered_image, edge_detected_image] #image2
    #imagesName = ['gray', 'blurred', 'thresh', 'img', 'grey', 'adthresh', 'bilateral_filtered_image', 'edge_detected_image'] # 'image2',
    images = [grey]#, blurred]#, thresh, img, grey, adthresh, bilateral_filtered_image, edge_detected_image] #image2
    imagesName = ['grey']#, 'blurred']#, 'thresh', 'img', 'grey', 'adthresh', 'bilateral_filtered_image', 'edge_detected_image'] # 'image2',
